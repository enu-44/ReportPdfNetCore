...
namespace pmacore_api.Controllers.Pdfreport
{
    ...
    public class AutorizacionPdfReport
    {
				 ...
				 header.HtmlHeader(rptHeader =>
				 {
					...
					var cliente = dataGroup.GetSafeStringValueOf<DataRequest>(x => x.Cliente);
						...
						var table_totals= string.Format(@"
								<tr style='text-align: center;'>
									<td style='width: 78.6667px; font-size: 11px; background-color: #909497;' colspan='6'  bgcolor='#909497'>TOTAL VI&Aacute;TICOS A PAGAR</td>
									<td style='width: 78.6667px; font-size: 11px;'>$ {0}</td>
									<td style='width: 78.6667px; font-size: 11px;'>$ {1}</td>
									<td style='width: 78.6667px; font-size: 11px;'>$ {2}</td>
									<td style='width: 79.5556px; font-size: 11px;'>$ {3}</td>
									<td style='width: 78.6667px; font-size: 11px;'>$ {4}</td>
								</tr>
								<tr style='text-align: center;'>
									<td style='width: 78.6667px; font-size: 11px;'>Son:</td>
									<td style='width: 78.6667px; font-size: 11px;' colspan='10'>{5}</td>
								</tr>
							
								<tr style='text-align: center;'>
									<td style='width: 78.6667px; font-size: 10px; vertical-align: top;' colspan='11'>
										<p>Importante:</p>
								...
								<tr style='text-align: center;'>
									<td style='width: 78.6667px; font-size: 10px; color: #ff0000;' colspan='11'>*Manifiesto que he le&iacute;do y entendido en su integridad el presente formato, por lo cual firmo en calidad de aceptaci&oacute;n</td>
								</tr>
								<tr style='text-align: center;'>
												<td style='width: 78.6667px; font-size: 11px;' colspan='11'><br></td>
								</tr>
								<tr  style='text-align: center; height: 50px'>
										<td style='width: 78.6667px; font-size: 11px;' colspan='4'><br><br></td>
										<td style='width: 78.6667px; font-size: 11px;' colspan='4'><br><br></td>
										<td style='width: 78.6667px; font-size: 11px;' colspan='3'><br><br></td>
								</tr>
								<tr style='text-align: center'>
									...
									<td style='width: 78.6667px; font-size: 10px;'   colspan='3'>
													<p>FIRMA </p>
									</td>
								</tr>
								<tr style='text-align: center;'>
									<td style='width: 78.6667px; font-size: 10px;' colspan='11'>
					...
					var detalle_solicitud= string.Format(@"
						...
						<tr>
							...
							<td align='center' colspan='4' rowspan='3'><strong>FORMATO DE AUTORIZACION GASTOS DE VIAJE (VIATICOS)</strong></td>
							<td colspan='3'>
								<table   style='width: 100%;'>
									<tr>
										<td bordercolor='#B2B2B2'>Version 0.2</td>
									</tr>
									<tr>
