   ...
   public class HtmlCellTemplatePdfReport
    {
        ...
        {
            return CreateHtmlCellTemplatePdfReport(wwwroot).GenerateAsByteArray(); // creating an in-memory PDF file
        }
        public static IPdfReportData CreateHtmlHeaderPdfReportStream(string wwwroot, Stream stream)
        {
            return CreateHtmlCellTemplatePdfReport(wwwroot).Generate(data => data.AsPdfStream(stream, closeStream: false));
        }
        
        public  static PdfReport CreateHtmlCellTemplatePdfReport(String wwwroot)
        {
            return new PdfReport().DocumentPreferences(doc =>
            {
             ...
             .MainTableDataSource(dataSource =>
             {
                 ...
                 for (int i = 0; i < 100; i++)
                 {
                     ...
                     var photo= Path.Combine(wwwroot, "Images","01.png");
